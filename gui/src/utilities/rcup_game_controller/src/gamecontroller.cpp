...
// : m_teamNumber("/behavior/game_controller/team_number", 0, 1, 80, 1)
// , m_robotNumber("/behavior/game_controller/robot_number", 0, 1, 5, 3)
{
	ros::NodeHandle nh("~");

	m_pubData = boost::make_shared<GCData>();

	m_pubGC = nh.advertise<GCData>("/game_controller/data", 1);
